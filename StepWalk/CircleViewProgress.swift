...
@objc @IBDesignable open class CircleViewProgress: UIView {
    ...
    @objc func internalInit() {
        let displayLink = CADisplayLink(target: self, selector: #selector(CircleViewProgress.displayLinkTick))
